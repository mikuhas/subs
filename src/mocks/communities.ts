...
export const mockCommunities: Community[] = [
  ...
  { id: 6,  name: '読書サロン',         tag: '読書',         description: '本の感想を語り合ったり、読書会を開こう。',                           emoji: '📚', memberCount: 167 },
  ...
  { id: 12, name: 'ファッション部',     tag: 'ファッション', description: 'コーデを語ったり、一緒にショッピングを楽しもう。',                     emoji: '👗', memberCount: 312 },
  ...
  { id: 15, name: 'クリエイター集会',   tag: 'クリエイター', description: 'デザイン・動画・イラストを語り合う仲間を募集！',                       emoji: '🎨', memberCount: 221 },
